...
- Accident Location (street address or intersection, Title Case; lower half of doc)
...
- client_street_name (street name only from Vehicle 1 driver address, Title Case, no suffix e.g. "Illinois Avenue"; left side of form)
- client_city (city only from Vehicle 1 driver address, Title Case, no suffix e.g. "Chicago"; left side of form)
